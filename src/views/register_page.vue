  ...
  <div style="background-color: rgba(255,255,255,0.85);">
    <v-card :loading="loading" class="mx-auto my-12" width="450" style="background-color: rgba(255, 255, 255, 0.85);">
      ...
      <div style="width:350px;margin-left:50px;margin-top: 0px;color: palevioletred;">
        <v-row>
          <v-col>
            <v-text-field v-model="form.username" label="昵称" clearable style="color:palevioletred"></v-text-field>
          </v-col>
          <v-col>
            <v-text-field v-model="form.relname" label="真实姓名" clearable style="color:palevioletred"
              color="palevioletred"></v-text-field>
          </v-col>
        </v-row>
        <v-row>
          <v-col>
        ...
        <v-row>
          <v-col>
            <v-text-field v-model="form.email" label="邮箱" clearable></v-text-field>
          </v-col>
          <v-col>
            <v-text-field v-model="form.phonenumber" label="手机号码（选填）" clearable></v-text-field>
          </v-col>
        </v-row>
        <v-bottom-navigation :value="value" color="pink" style="width: 100%;">
