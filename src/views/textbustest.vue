<template>
  <div>
    <div>
      ...
      <div>
        <el-table :data="this.textdata" height="600" border stripe style="position:absolute;width: 60vh;top:12vh"
          @cell-click="find">
      ...
      <div v-if="this.ifnew === 0">
        <el-tooltip class="item" effect="dark" content="新建文档" placement="bottom">
          <div style="position: absolute;width:40px;height:40px;left:60px;top:55px"><i class="el-icon-plus" style=""
              @click="changenew"></i></div>
        </el-tooltip>
        <el-tooltip class="item" effect="dark" content="删除当前文档" placement="bottom">
          <div style="position: absolute;width:40px;height:40px;left:220px;top:55px"><i class="el-icon-delete-solid"
              style="" @click="deletetxt"></i></div>
        </el-tooltip>
        <el-tooltip class="item" effect="dark" content="保存文档" placement="bottom">
          <div style="position: absolute;width:40px;height:40px;left:380px;top:55px"><i class="el-icon-document-checked"
