...
<v-card style="width:400px">
    ...
    <v-btn @click="send_code" style="background-color: white;margin-bottom: 8px;width: 100%;">点击发送验证码</v-btn>
    <v-text-field outlined label="验证码" v-model="code"></v-text-field>
    <v-text-field outlined label="密码确认" v-model="password2"></v-text-field>
    <v-btn @click="reset_password" style="background-color: white;margin-bottom: 8px;width: 100%;">重置</v-btn>
